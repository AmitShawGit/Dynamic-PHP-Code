        ...
        <div class="row">
            ...
            <?php
              ...
              if(isset($_POST['submit'])){
                ...
                $updatequery = " update product set id=$id, image='$pimage', pname='$pname', pdesc='$pdesc', mrp='$mrp', quantity='$quantity' where id = $id ";
            ...
            ?>
                ...
                <div class="form-group">
                    <label for="producthead"> Product Name </label>
                        <input type="text" name="pname" id="producthead" class="form-control" value="<?php echo $res['pname'];?>">
                  
                </div>
                <div class="form-group">
                    <label for="productsd">About the product</label>
                        <input type="text" name="pdesc" id="productsd" class="form-control" value="<?php echo $res['pdesc'];?>">
                    
                </div>
                <div class="form-group">
                    <label for="productprice">Price</label>
                        <input type="text" name="mrp" id="productprice" class="form-control" value="<?php echo $res['mrp'];?>">
                    
                </div>
                <div class="form-group">
                    <label for="quantity">Quantity</label>
                        <input type="text" name="quantity" id="pquantity" class="form-control" value="<?php echo $res['quantity'];?>">
